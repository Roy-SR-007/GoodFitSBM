...
GoodFitSBM (Version 0.0.1): `GoodFitSBM` comprises functionality that performs the *goodness-of-fit* test for a **ER-SBM** as well as a **beta-SBM** (two of the three variants of SBMs as discussed in [Karwa et al. (2023)](https://doi.org/10.1093/jrsssb/qkad084), used for modelling network data).
